  ...
  return (
    <div class='flex flex-col gap-6'>
      ...
      <section class='flex flex-col gap-2'>
        ...
        {mapping_result.by_concept.size
          ? (
            <ul class='flex flex-col gap-1 list-disc list-inside'>
              {[...mapping_result.by_concept.keys()].map((record) => (
                <li key={record.specific_snomed_concept_id} class='text-sm text-gray-900'>
                  {record.specific_snomed_concept_id}
                </li>
              ))}
            </ul>
          )
      ...
      <SnomedIcd10MappingAudit mappings={mapping_result} />
