...
export type EncounterReason = "appointment" | "checkup" | "emergency" | "follow up" | "other" | "referral" | "seeking treatment";

export type EncounterStep = "clinical_notes" | "close_visit" | "diagnosis" | "diagnostic_tests" | "examinations" | "general_assessments" | "orders" | "prescriptions" | "referral" | "symptoms" | "vitals";

export type FamilyType = "2 married parents" | "Blended" | "Child-headed" | "Divorced" | "Extended" | "Grandparent-led" | "Orphan" | "Polygamous/Compound" | "Same-sex marriage" | "Single Parent";
...
export type IntakeStep = "address" | "conditions" | "family" | "history" | "lifestyle" | "occupation" | "personal" | "review";
...
export type NurseSpecialty = "anaesthetist" | "clinical care" | "clinical officer" | "community" | "dental" | "intensive and coronary care" | "midwife" | "neonatal intensive care and paediatric" | "oncology and palliative care" | "operating theatre" | "opthalmic" | "orthopaedic" | "primary care" | "psychiatric mental health" | "registered general" | "renal" | "trauma care";

export type PatientCohabitation = "Father" | "Foster Parent" | "Grandparent(s)" | "Mother" | "Orphanage" | "Other Relative" | "Sibling" | "Uncle or Aunt";

export type PatientConversationState = "find_nearest_facility:got_location" | "find_nearest_facility:send_facility_location" | "find_nearest_facility:share_location" | "initial_message" | "not_onboarded:make_appointment:enter_date_of_birth" | "not_onboarded:make_appointment:enter_gender" | "not_onboarded:make_appointment:enter_name" | "not_onboarded:make_appointment:enter_national_id_number" | "not_onboarded:welcome" | "onboarded:appointment_scheduled" | "onboarded:cancel_appointment" | "onboarded:main_menu" | "onboarded:make_appointment:confirm_details" | "onboarded:make_appointment:enter_appointment_reason" | "onboarded:make_appointment:first_scheduling_option" | "onboarded:make_appointment:initial_ask_for_media" | "onboarded:make_appointment:other_scheduling_options" | "onboarded:make_appointment:subsequent_ask_for_media" | "other_end_of_demo";

export type Religion = "African Traditional Religion" | "Apostolic Sect" | "Islam" | "Non-Religious" | "Other" | "Pentecostal/Protestant Christianity" | "Roman Catholic";
