          ...
          <>
            ...
            <YesNoQuestion
              ...
              onChange={(value) => {
                ...
                console.log('Value for has_traded_sex_for_favors: ', value)
                console.log(
                  'has_traded_sex_for_favors in object',
                  sexual_activity.value.has_traded_sex_for_favors,
                )
              }}
            />
            <YesNoQuestion
  ...
  return (
    <section className='mb-7'>
          ...
          <>
            <YesNoQuestion
              ...
              onChange={(value) => {
                ...
                console.log('Value for currently_drinks: ', value)
                console.log('alcohol.value.currently_drinks in object: ', value)
              }}
            />
            <YesNoQuestion
      ...
      {alcohol.value.has_ever_drank === true &&
        ...
        <ListboxItem
          question={'Which alcoholic drinks, does the patient take?'}
          ...
          // alcohol.value = {
          //   ...alcohol.value,
          //   alcohol.value.ever_drank: true,
          //   alcohol.value.alcohol_products_used: selectedValues,
          // }}
        />
      )}
    </section>
  ...
  return (
    <section className='mb-7'>
      ...
      {smoking.value.has_ever_smoked === true &&
        ...
        <ListboxItem
          question={'Which tobacco products does the patient use?'}
