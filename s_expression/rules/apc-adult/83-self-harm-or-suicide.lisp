...
(task
  ...
  (check_for
    ...
    (<= (onset (clinical_finding (snomed_concept "Suicidal thoughts" "finding")))
        (time_ago 1 months))
    (<= (onset (clinical_finding (snomed_concept "Planning suicide" "finding")))
        (time_ago 1 months))
    (<= (onset (clinical_finding (snomed_concept "Intentionally harming self" "event")))
        (time_ago 1 years))
    (<= (onset (clinical_finding (snomed_concept "Suicide attempt" "event")))
        (time_ago 1 years))
