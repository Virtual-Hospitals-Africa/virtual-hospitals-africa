...
(task
  ...
  (check_for
    ...
    (clinical_finding (snomed_concept "Muscle weakness of limb" "finding"))
		...
		(clinical_finding ( snomed_concept “Injury of neck” (disorder) Recent (qualifier value) Plain X-ray of cervical spine abnormal (finding))
		(clinical_finding ( snomed_concept “Injury of neck” (disorder)Recent (qualifier value) Plain X-ray of neck (procedure) Not available (qualifier value))
  )
)
