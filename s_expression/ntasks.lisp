...
(task
  ...
  (check_for
    ...
    (clinical_finding (snomed_concept "Acute constipation" "finding"))In the past (qualifier value) hour (qualifier value) 24))
    ...
    (clinical_finding (snomed_concept "Pain radiating to lumbar region of back" "finding")Vomiting (disorder) With (attribute))
		(clinical_finding ( snomed_concept “Abdominal pain” (finding) Structure of right lower quadrant of abdomen (body structure) Nausea (finding) With 		(attribute))
		(clinical_finding ( snomed_concept “Abdominal pain” (finding) Structure of right lower quadrant of abdomen (body structure) (clinical_finding ( snomed_concept “Vomiting (disorder) With (attribute))
		(clinical_finding ( snomed_concept “Right lower quadrant pain” (finding) Fever (finding) With (attribute))
		(clinical_finding ( snomed_concept “Right upper quadrant pain” (finding) 	Severe (severity modifier) (qualifier value) Nausea 		(finding) With (attribute))
		(clinical_finding ( snomed_concept “Right upper quadrant pain” (finding) 	Severe (severity modifier) (qualifier value) Fever (finding) With (attribute))
		(clinical_finding ( snomed_concept “Right upper quadrant pain” (finding) Severe (severity modifier) (qualifier value) Loss of appetite (finding) With (attribute))
		(clinical_finding ( snomed_concept “Upper abdominal pain” (finding) Sudden (qualifier value) Severe (severity modifier) (qualifier value) Pain radiating to lumbar region of back (finding) Nausea (finding) With (attribute))
