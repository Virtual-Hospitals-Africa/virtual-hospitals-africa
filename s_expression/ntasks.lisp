...
(task
  ...
  (check_for
    ...
    (clinical_finding (snomed_concept "Muscle weakness of limb" "finding"))
		...
		(clinical_finding ( snomed_concept “Traumatic or non-traumatic injury of back” (disorder)  Plain X-ray of lumbar spine abnormal (finding))
		(clinical_finding ( snomed_concept “Traumatic or non-traumatic injury of back” (disorder) Plain X-ray of lumbar vertebral column region (procedure) Not available (qualifier value))
		(clinical_finding ( snomed_concept “Upper abdominal pain” (finding) Sudden onset (qualifier value) Severe (severity modifier) (qualifier value) Pain radiating to lumbar region of back (finding))
    (clinical_finding (snomed_concept "Pulsatile mass of abdomen" "finding"))
