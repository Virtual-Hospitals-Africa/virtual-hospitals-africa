...
(task
  ...
  (check_for
    ...
    (clinical_finding ( snomed_concept “Pain in muscle of lower limb” (finding) “Pain onset during moderate exercise” (finding) “Ischemic foot with rest pain” (disorder) “Associated with” (attribute))
		(clinical_finding ( snomed_concept “Pain in muscle of lower limb” (finding) “Pain onset during moderate exercise” (finding) “Gangrene” (morphologic abnormality) “Associated with” (attribute))
		(clinical_finding ( snomed_concept “Pain in muscle of lower limb” (finding) “Pain onset during moderate exercise” (finding) “Ulcer” (morphologic abnormality) “Associated with” (attribute))
		(clinical_finding ( snomed_concept “Muscle pain” (finding) “Buttock structure” (body structure) “Right and left” (qualifier value) “Pain onset during moderate exercise” (finding) “Ischemic foot with rest pain” (disorder) “Associated with” (attribute))
		(clinical_finding ( snomed_concept “Muscle pain” (finding) “Buttock structure” (body structure) “Right and left” (qualifier value) “Pain onset during moderate exercise” (finding) “Gangrene of foot” (disorder) “Associated with” (attribute))
		(clinical_finding ( snomed_concept “Muscle pain” (finding) “Buttock structure” (body structure) “Right and left” (qualifier value) “Pain onset during moderate exercise” (finding) “Ulcer of foot” (disorder) “Associated with” (attribute))
    (clinical_finding (snomed_concept "Unable to weight-bear" "finding") “Injury of foot” (disorder) “After” (attribute))
  )
)
