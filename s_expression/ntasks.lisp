...
(task
  ...
  (check_for
    ...
    (clinical_finding (snomed_concept "Numbness of limbs" "finding"))
    (clinical_finding (snomed_concept "Muscle weakness of limb" "finding"))
    (clinical_finding ( snomed_concept “Pain in muscle of lower limb” (finding) “Pain onset during moderate exercise” (finding) “Pain provoked by rest” (finding) “Associated with” (attribute))
    ...
    (clinical_finding ( snomed_concept “Injury of lower limb” (disorder))
		(clinical_finding ( snomed_concept “Muscle pain” (finding) “Buttock structure” (body structure) “Right and left” (qualifier value) “Pain onset during moderate exercise” (finding) “Pain provoked by rest” (finding) “Associated with” (attribute))
		(clinical_finding ( snomed_concept “Muscle pain” (finding) “Buttock structure” (body structure) “Right and left” (qualifier value) “Pain onset during moderate exercise” (finding) “Gangrene” (morphologic abnormality) “Associated with” (attribute))
		(clinical_finding ( snomed_concept “Muscle pain” (finding) “Buttock structure” (body structure) “Right and left” (qualifier value) “Pain onset during moderate exercise” (finding) “Ulcer” (morphologic abnormality) “Associated with” (attribute))
