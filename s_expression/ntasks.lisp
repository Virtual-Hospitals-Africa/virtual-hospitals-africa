...
(task
  ...
  (check_for
    ...
    (clinical_finding (snomed_concept "Right lower quadrant pain” (finding))
		(clinical_finding ( snomed_concept “Upper abdominal pain” (finding) Sudden (qualifier value) Severe (severity modifier) (qualifier value)) Pain radiating to lumbar region of back (finding))
