...
(task
  ...
  adult
	...
	(clinical_finding ( snomed_concept “Generalized rash” (disorder) Itching 	(finding) “With” (attribute))
	(clinical_finding ( snomed_concept “Localized eruption of skin” (disorder) “Itching” (finding) “With” (attribute))
	(clinical_finding ( snomed_concept “Generalized rash” (disorder) “No itch” (situation) “With” (attribute))
  (check_for
		...
		(clinical_finding ( snomed_concept “Wheezing” (finding))
		(clinical_finding (snomed_concept “Difficulty breathing” (finding))
		(clinical_finding (snomed_concept “Dizziness” (finding)) 							            		(clinical_finding ( snomed_concept “Collapse” (finding))
    ...
    (clinical_finding (snomed_concept "Stiff neck" "finding"))
		...
		(clinical_finding ( snomed_concept “Clouded consciousness” (finding))
		(clinical_finding ( snomed_concept “Headache” (finding))
		(clinical_finding ( snomed_concept “Generalized rash” (disorder) “New medication commenced” (finding) “In the past” (attribute) “month” (qualifier value)3))
    (clinical_finding (snomed_concept "Jaundice" "finding"))
