...
(task
  ...
  (check_for
    ...
    (clinical_finding (snomed_concept "Jaundice" "finding"))
		...
		(clinical_finding (snomed_concept “Pregnancy” (finding) OR <= Postpartum period, 7 days (finding)
		AND 
...
(clinical_finding (snomed_concept “Swelling of eyelid” (finding) Both eyes, entire (body structure) Entire (qualifier value)
...
(clinical_finding (snomed_concept “Ptosis of eyelid” (disorder) Sudden (qualifier value)
