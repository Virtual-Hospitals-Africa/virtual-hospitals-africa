...
(task
  ...
  (check_for
    ...
    (clinical_finding (snomed_concept "Full thickness burn" "disorder"))Structure of body surface region (body structure)
    (clinical_finding (snomed_concept "Partial thickness burn" "disorder") (qualifier (snomed_concept "Structure of body surface region (body structure)
