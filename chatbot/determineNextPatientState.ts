...
export default function determineNextPatientState(
  ...
  if (currentState.type === "select") {
    ...
    onResponse = findMatchingListOption(currentState.action(patientMessage), messageBody)!.onResponse;
  } else {
  ...
  //     : currentState.type === "list"
  //     ? findMatchingListOption(currentState.action(patientMessage), messageBody)
  //     : currentState;
