const patient_presence = {
  ...
  //   const next_departments: Department[] = WORKFLOW_DEPARTMENTS[next_workflow]
  //   assertLength(next_departments, 1)
  ...
  // },
  set(trx, patient_id, updates) {
    return trx.updateTable("patient_presence").set(updates).where("id", "=", patient_id).executeTakeFirstOrThrow();
  }
};
export {
  patient_presence as p
};
