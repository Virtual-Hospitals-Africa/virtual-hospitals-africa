          ...
          .select((eb_patient_triage_level) => [
            jsonArrayFrom(
              eb_patient_triage_level
                ...
                .innerJoin(
                  'patient_records as patient_records_for_this_encounter_with_identical_triage_level',
                  'patient_records_for_this_encounter_with_identical_triage_level.id',
                  'triage_level_for_this_encounter_with_identical_triage_level.id',
                )
                .whereRef(
                  'patient_records_for_this_encounter_with_identical_triage_level.value_snomed_concept_id',
                  '=',
                  'patient_records.value_snomed_concept_id',
                )
