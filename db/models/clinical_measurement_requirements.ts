import { TrxOrDb, VitalMeasurementFormInputDefition } from '../../types.ts'
import { VITALS_SNOMED_CODE, VITALS_UNITS } from '../../shared/vitals.ts'
import generateUUID from '../../util/uuid.ts'
import { PatientClinicalContext } from './patient_clinical_context.ts'
  ...
  for (const requirement of requirements) {
    ...
    if (!existing) {
      ...
      const should_replace =
        (requirement.frequency_recommendation &&
