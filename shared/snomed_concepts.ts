// deno-fmt-ignore
export const YES_QUALIFIER = { id: '373066001', name: 'Yes', category: 'qualifier value' }
export const NO_QUALIFIER = {
  id: '373067005',
  name: 'No',
  category: 'qualifier value',
}
export const UNKNOWN_QUALIFIER = {
  id: '261665006',
  name: 'Unknown',
  category: 'qualifier value',
}
export const NO_KNOWN_QUALIFIER = {
  id: '1381510001',
  name: 'No known',
  category: 'qualifier value',
}
export const ACTIVE_QUALIFIER = {
  id: '55561003',
  name: 'Active',
  category: 'qualifier value',
}
...
export const SELF_REPORTED_QUALIFIER = {
  id: '1156040003',
  name: 'Self reported',
  category: 'qualifier value',
}
...
export const EVALUATION_ACTION = {
  id: '129265001',
  name: 'Evaluation - action',
  category: 'qualifier value',
}
export const EVENT = { id: '272379006', name: 'Event', category: 'event' }
