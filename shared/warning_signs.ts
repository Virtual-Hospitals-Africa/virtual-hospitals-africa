...
export const WARNING_SIGNS = {
  'Obstructed airway': {
    'clinical_finding_s_expression': '(finding 404684003 79688008)',
  ...
  'Seizure': {
    'clinical_finding_s_expression':
      '(finding 404684003 91175000 (qualifier 15240007))',
    'sats_primary_name': 'Seizure',
    'sats_secondary_text': 'Current',
    'sats_priority': 'Emergency',
  },
  'Burn Facial': {
    'clinical_finding_s_expression': '(finding 404684003 262582004)',
    'sats_primary_name': 'Burn',
    'sats_secondary_text': 'Facial',
    'sats_priority': 'Emergency',
  },
  'Burn Inhalation': {
    'clinical_finding_s_expression': '(finding 404684003 425082000)',
    'sats_primary_name': 'Burn',
    'sats_secondary_text': 'Inhalation',
    'sats_priority': 'Emergency',
  },
  'Cardiac arrest': {
    'clinical_finding_s_expression': '(finding 404684003 410429000)',
  ...
  'High energy transfer': {
    'clinical_finding_s_expression': '(finding 404684003 400209005)',
  ...
  'Focal neurology — acute': {
    'clinical_finding_s_expression': '(finding 404684003 230690007)',
  ...
  'Shortness of breath - acute': {
    'clinical_finding_s_expression':
      '(finding 404684003 267036007 (qualifier 24484000))',
    'sats_primary_name': 'Shortness of breath - acute',
    'sats_secondary_text': null,
    'sats_priority': 'Very urgent',
  },
  'Aggression': {
    'clinical_finding_s_expression': '(finding 404684003 61372001)',
    'sats_primary_name': 'Aggression',
    'sats_secondary_text': null,
    'sats_priority': 'Very urgent',
  },
  'Burn Chemical': {
    'clinical_finding_s_expression': '(finding 404684003 426284001)',
    'sats_primary_name': 'Burn',
    'sats_secondary_text': 'Chemical',
    'sats_priority': 'Very urgent',
  },
  'Threatened limb': {
    'clinical_finding_s_expression': '(finding 404684003 21631000119105)',
  ...
  'Overdose': {
    'clinical_finding_s_expression': '(finding 404684003 1149222004)',
    'sats_primary_name': 'Overdose',
    'sats_secondary_text': null,
    'sats_priority': 'Very urgent',
  },
  'Coughing blood': {
    'clinical_finding_s_expression': '(finding 404684003 66857006)',
    'sats_primary_name': 'Coughing blood',
    'sats_secondary_text': null,
    'sats_priority': 'Very urgent',
  },
  'Eye injury': {
    'clinical_finding_s_expression': '(finding 404684003 231794000)',
    'sats_primary_name': 'Eye injury',
    'sats_secondary_text': null,
    'sats_priority': 'Very urgent',
  },
  'Chest pain': {
    'clinical_finding_s_expression': '(finding 404684003 29857009)',
  ...
  'Vomiting fresh blood': {
    'clinical_finding_s_expression': '(finding 404684003 267051003)',
    'sats_primary_name': 'Vomiting fresh blood',
    'sats_secondary_text': null,
    'sats_priority': 'Very urgent',
  },
  'Stabbed neck': {
    'clinical_finding_s_expression': '(finding 404684003 283457003)',
    'sats_primary_name': 'Stabbed neck',
    'sats_secondary_text': null,
    'sats_priority': 'Very urgent',
  },
  'Fractured - compound': {
    'clinical_finding_s_expression': '(finding 404684003 52329006)',
  ...
  'Pregnancy and abdominal pain': {
    'clinical_finding_s_expression': '(finding 404684003 21522001)',
  ...
  'Hemorrhage Uncontrolled': {
    'clinical_finding_s_expression':
      '(finding 404684003 131148009 (qualifier 19032002))',
  ...
  // {
  //   'clinical_finding_s_expression': '(finding 404684003 212049006)',
  ...
  // },
  'Seizure - post ictal': {
    'clinical_finding_s_expression': '(finding 404684003 31758001)',
    'sats_primary_name': 'Seizure - post ictal',
    'sats_secondary_text': null,
    'sats_priority': 'Very urgent',
  },
  'Severe pain': {
    'clinical_finding_s_expression': '(finding 404684003 76948002)',
  ...
  'Burn Moderate severity': {
    'clinical_finding_s_expression':
      '(finding 404684003 284549007 (qualifier 6736007))',
    'sats_primary_name': 'Burn',
  ...
  'Haemorrhage Controlled': {
    'clinical_finding_s_expression':
      '(finding 404684003 131148009 (qualifier 31509003))',
    'sats_primary_name': 'Haemorrhage',
    'sats_secondary_text': 'Controlled',
    'sats_priority': 'Urgent',
  },
  'Dislocation of finger': {
    'clinical_finding_s_expression': '(finding 404684003 827108008)',
    'sats_primary_name': 'Dislocation of finger',
    'sats_secondary_text': null,
    'sats_priority': 'Urgent',
  },
  'Dislocation of toe joint': {
    'clinical_finding_s_expression': '(finding 404684003 263030002)',
    'sats_primary_name': 'Dislocation of toe joint',
    'sats_secondary_text': null,
    'sats_priority': 'Urgent',
  },
  'Fracture': {
    'clinical_finding_s_expression': '(finding 404684003 423125000)',
  ...
  'Persistent vomiting': {
    'clinical_finding_s_expression': '(finding 404684003 196746003)',
