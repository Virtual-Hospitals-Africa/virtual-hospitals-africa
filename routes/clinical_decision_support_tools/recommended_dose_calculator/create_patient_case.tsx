      ...
      >
        ...
        <FormSection header='SNOMED Diagnoses'>
          <TextInput
            ...
            label='Optional. Each SNOMED concept is translated to suggested ICD-10 candidate code(s) for matching — never applied without your review.'
          />
        </FormSection>

        <div>
          <Button type='submit'>Review suggested doses</Button>
        </div>
      </Form>
    </HealthWorkerContentsWithSidebarAndDrawer>
  )
