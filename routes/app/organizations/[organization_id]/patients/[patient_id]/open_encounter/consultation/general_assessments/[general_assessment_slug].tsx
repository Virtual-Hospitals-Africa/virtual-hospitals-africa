import { completeAssessment, GeneralAssessmentsContext, GeneralAssessmentsPage } from './_middleware.tsx'
...
import { generated_uuid, snomed_concept_id } from '../../../../../../../../../util/validators.ts'
  ...
  findings: z.any()
    ...
    .pipe(z.array(
      z.object({
        ...
        additional_notes: z.string().nullable().optional().transform((v) => v || null),
